    ...
    <div className="my-20 px-6 lg:px-16">
      <div className="bg-white rounded-[25px] shadow-lg py-5">
        ...
        <div className="md:mt-20 mt-10">
          <p className="md:px-32 px-5 poppins text-[#0B0B0B] text-center ">
            As you step indoors, a realm unfurls where tradition converges with
            innovation, marrying hand-carved embellishments seamlessly with
            modern conveniences.
          </p>
        </div>
      </div>
