...
const Carousel_slider = () => {
  ...
  return (
    <div className="md:px-20 px-5 py-5">
      ...
      <div className="flex flex-col justify-center relative bottom-[100px] md:bottom-[85px] z-10">
        <h3 className="text-center text-white poppins font-bold mb-5 text-xl md:text-2xl">Embark on our Jounrey with Our Traditional Creations</h3>
