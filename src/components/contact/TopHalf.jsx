  ...
  return (
    <div className="bg-[#1E3888] px-5 py-7 rounded-[20px]">
      <div className="">
        <FontAwesomeIcon
          icon={icon}
          className="text-white w-[20%] flex m-auto"
        />
        <h1 className="my-5 poppins font-bold text-white text-center text-3xl">
          {name}
        </h1>
        <p className="my-5 text-white poppins font-semibold text-center text-lg">
          {l1}
        </p>
          ...
          <button
            onClick={() => {
              if (btn === "CALL") {
                ...
                router.push(`mailto:${l3}`);
              }
            }}
            className="bg-white px-5 py-3 rounded-[20px] items-center text-black flex font-bold poppins text-lg"
          >
            {btn}
          </button>
        </div>
