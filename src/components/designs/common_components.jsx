        ...
        <div className="my-5">
          ...
          <div className="flex justify-center">
            <div
              className={
                data.type == "DELUXE"
                  ? "text-center px-5 py-2 bg-[#00FFF9] rounded-[20px]"
                  : data.type == "LUXURY"
                  ? "text-center px-5 py-2 bg-[#FFD600] rounded-[20px]"
                  : data.type == "PREMIUM"
                  ? "text-center px-5 py-2 bg-[#20FF79] rounded-[20px]"
          ...
          <div className="flex justify-center my-5">
            <div className="px-3 py-2 bg-black rounded-[5px] flex">
              {starArray &&
                starArray.map((_, i) => (
                  <UisStar key={i} className="text-yellow-500 h-[20px]" />
                ))}
            </div>
          </div>
          <div className="">
